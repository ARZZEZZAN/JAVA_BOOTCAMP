...
public class MessageRepositoryImpl implements MessageRepository {
    ...
    public void save(Message entity) {
        int result = jdbcTemplate.update("INSERT INTO chat.message(ownerId, messageText) VALUES(?, ?)",
                entity.getOwnerId(),
    ...
    public void update(Message entity) {
        ...
        int result = jdbcTemplate.update("UPDATE chat.message SET ownerId = ?, messageText = ?, dateTime = ? WHERE id = ?",
                entity.getOwnerId(),
                entity.getMessageText(),
                entity.getDateTime(),
                entity.getId());
